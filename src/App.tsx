      ...
      <div className="slideshow">
        <div className="slide" style={{ marginLeft: `${-slide * 100}%` }}>
          <div className="content">
            ...
            <div className="text">
              <p>
                I got 1+ years of experience in technologies such as React,
                Django, Express, postgreSQL, Typescript, docker, AWS and more.
                I'm always learning and trying to give my best in everything I
                do. I'm excellent at creating technological solutions, i have
                been part of the creation of three successful projects (B2B, B2C
                and an internal project) in the different companies I've worked
                with. Right now, I'm working for a Canadian company as a full
                stack developer.
              </p>
            </div>
          </div>
        ...
        <div className="slide show">
          ...
          <Carousel data={[{
            ...
            description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit sequi doloribus dolores, quod quas cum corporis et, nulla ipsum aspernatur quidem, sed quibusdam. Nulla cumque eveniet aliquam mollitia libero deserunt!' 
          },
          {
            image: imgURL,
        ...
        <button
          ...
          style={{ border: `1px solid ${colors[slide]}` }}
        >
          <FontAwesomeIcon icon={faArrowRight} color={colors[slide]} />
        </button>
      </div>
      <footer style={{ color: colors[slide] }}>@2023 Germán Vargas</footer>
    </>
  );
}
